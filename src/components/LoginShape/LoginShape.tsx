...
export const LoginShape = () => {
    ...
    return (
        <>
                ...
                <svg width="1394" height="791" viewBox="0 0 1394 791" fill="none" xmlns="http://www.w3.org/2000/svg" className="fixed z-[-1] bottom-0 right-0 ">
                ...
                </svg><svg width="297" height="156" viewBox="0 0 297 156" fill="none" xmlns="http://www.w3.org/2000/svg" className="fixed z-[-1] top-1 left-[720px]">
                    ...
                    </svg><svg width="227" height="329" viewBox="0 0 227 329" fill="none" xmlns="http://www.w3.org/2000/svg" className="fixed z-[-1] bottom-0 left-0">
