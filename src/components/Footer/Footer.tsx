            ...
            <div className="h-1/2 w-full flex flex-col justify-center items-center">
                <div className="h-4/5 w-2/4 md:w-2/4 lg:w-[30%] flex items-center justify-between">
                    <div className=" h-[48px] lg:h-[65px] md:h-[55px] w-[48px] lg:w-[65px] md:w-[55px] rounded-full border-2 flex items-center justify-center">
                        <img src="./Assets/iconsSocial/Instagram.svg" alt="" className="h-[28px] lg:h-[48px] md:h-[32px] w-[28px] lg:w-[48px] md:w-[32px]" />
                    </div>

                    <div className="h-[48px] lg:h-[65px] md:h-[55px] w-[48px] lg:w-[65px] md:w-[55px] rounded-full border-2 flex items-center justify-center">
                        <img src="./Assets/iconsSocial/iconTwitter.svg" alt="" className="h-[28px] lg:h-[48px] md:h-[32px] w-[28px] lg:w-[48px] md:w-[32px]" />
                    </div>

                    <div className="h-[48px] lg:h-[65px] md:h-[55px] w-[48px] lg:w-[65px] md:w-[55px] rounded-full border-2 flex items-center justify-center">
                        <img src="./Assets/iconsSocial/Link.svg" alt="" className="h-[28px] lg:h-[48px] md:h-[32px] w-[28px] lg:w-[48px] md:w-[32px]" />
                    </div>

                    <div className="h-[48px] lg:h-[65px] md:h-[55px] w-[48px] lg:w-[65px] md:w-[55px] rounded-full border-2 flex items-center justify-center">
                        <img src="./Assets/iconsSocial/iconFacebook.svg" alt="" className="h-[28px] lg:h-[48px] md:h-[32px] w-[28px] lg:w-[48px] md:w-[32px]" />
                    </div>
                </div>
