...
import { RenewColumnKanban } from "../ColumnKanban/RenewColumnKanban";
...
export const RenewKanban = ({ page, user }: Props) => {
                   ...
                   return (
                     ...
                     ((property.property.type ===
                       ...
                       (property.value as MultiOptionValued).value.find(
                         (value: Option) => value?.id == options[0]?.id
                       ))
                   );
                 });
               })
                 ...
                 return task?.task?.properties?.some((property) => {
                   return (
                     ...
                     ((property.property.type ===
                       ...
                       property.property.type === TypeOfProperty.TAG) &&
                       (property.value as MultiOptionValued).value.find(
                         (value: Option) => value?.id == options[1]?.id
                       ))
                   );
                 });
               })
                 ...
                 return task?.task?.properties?.some((property) => {
                   return (
                     ...
                     ((property.property.type ===
                       ...
                       property.property.type === TypeOfProperty.TAG) &&
                       (property.value as MultiOptionValued).value.find(
                         (value: Option) => value?.id == options[2]?.id
                       ))
                   );
                 });
               })
