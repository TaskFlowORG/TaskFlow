export const IconTextToSpeechOn = ({ classes }: { classes: string }) => {
  return (
    <svg width="800px" height="800px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" id="sound-min" fill="currentColor" className={" " + classes}>
