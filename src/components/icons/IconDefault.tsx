...
export const IconDefault = ({ isDefault = true, editing = false, ...props }: Props) => {
  ...
  return (
    ...
    >
      <If condition={isDefault || isHovered || editing}>
        <svg
          width="57"
          height="57"
          viewBox="0 0 57 57"
          ...
          {...props}
          className={
            props.className + (editing && isHovered ? "" : (!isDefault ? " opacity-50" : ""))
          }
        >
