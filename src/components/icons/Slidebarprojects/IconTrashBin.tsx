export const IconTrashBin = ({ classes }: { classes?: string }) => {

    return (
        <>
            <svg viewBox="0 0 14 17" fill="none" xmlns="http://www.w3.org/2000/svg" className={" w-full h-full max-h-6 " + classes}>
