export const IconTextToSpeechOff = ({ classes }: { classes: string }) => {
  return (
    <svg width="800px" height="800px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" id="sound-mute-alt" fill="currentColor" className={" " + classes }>
