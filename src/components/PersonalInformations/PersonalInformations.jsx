        ...
        <div className="flex flex-col h-48 gap-10">
          <div className="flex gap-10 ">
            <div className="h-full relative">
              <div
                id="fotoDeUsuario"
                className="relative rounded-full bg-slate-500 w-48 h-48"
              >
            ...
            <div className="grid grid-cols-2 grid-rows-4 gap-10 absolute text-modal-grey p">
              <div className="row-start-1 px-6  ">
                <label className="flex flex-col ">
                  Nome{" "}
                  <input
                    className=" shadow-blur-10   bg-input-grey-opacity border-2  border-input-grey border-opacity-[70%]  rounded-md  h-12 w-72  pl-4 focus:outline-none "
                    type="text"
              ...
              <div className="row-start-3  px-6  col-span-2">
                <label className="flex flex-col">
                  Descrição{" "}
                  <input
                    className="shadow-blur-10 bg-input-grey-opacity border-2  border-input-grey border-opacity-[70%]  rounded-md  h-12 w-full  pl-4 focus:outline-none"
                    type="text"
              ...
              <div className="row-start-4  px-6 ">
                <div>
                  <button className="h4 w-60  drop-shadow-xl  h-12 rounded-md bg-primary text-contrast">
                    Salvar alteraçoes
                  </button>
                </div>
              </div>
