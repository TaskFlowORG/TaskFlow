...
export const GroupUsersList = ({ userId }) => {
    ...
    return (
        <div>
            <div className="">
                <div className="border rounded-md border-[#F04A94] px-4 pr-6 bg-[#FCFCFC]  dark:bg-[#3C3C3C] dark:border-[#F76858] h-12 flex items-center justify-between">
                    <div className="flex gap-6">
                        <img className="" src="/img/User.svg" />
                        <p className="whitespace-nowrap dark:text-[#FCFCFC] text-black ">{user.name}</p>
                    </div>
                    <div className="text-[#F04A94] dark:text-[#F76858] flex gap-7">
                        <p>|</p>
