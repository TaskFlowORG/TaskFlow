...
export const GeneralConfig = () => {
  ...
  const [color, setColor] = useState<string>(
    (theme === "dark" ? user?.configuration.secondaryColor 
          ...
          <div className="w-[95%]">
            <div className="h-fit flex flex-col ">
              <div className="w-fit flex flex-col">
                ...
                <p>
                  Lorem ipsum dolor sit amet consectetur. Ut varius purus proin
                  a. Euismod placerat tortor ultrices at odio dolor turpis
                  vitae.
                </p>
              </div>
