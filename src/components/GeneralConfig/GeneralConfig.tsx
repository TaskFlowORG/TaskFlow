    ...
    return (
        <div className="flex w-[80%] h-[80%]">
                ...
                <div className='w-[90%] flex flex-col'>
                    ...
                    <div className='flex flex-col '>
                        <div className='flex justify-between items-center'>
                            ...
                            <input className=' w-[300px]' type="range" id='range' />
                        </div>
                        <div className='pt-5 pb-10 '>
            ...
            <div className='flex w-full '>
                <div className='flex w-full flex-col justify-around gap-10'>
                ...
                <div className='flex w-full h-full items-center flex-col justify-around gap-10'>
                    <div className='flex justify-center items-center w-64 h-64 bg-white shadow-blur-10'>
                        <div className='flex-col w-[80%] h-[80%]'>
                            <div className='flex justify-center items-center'>
                                <p className='h4 text-primary pb-6'>Acessibilidade</p>
                    ...
                    <div className='flex justify-center items-center w-44 h- bg-white shadow-blur-10'>
