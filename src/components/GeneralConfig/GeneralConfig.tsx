...
export const GeneralConfig = () => {
  ...
  const [googleCalendar, setGoogleCalendar] = useState<boolean>();
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 ">
            <div className="w-[95%] ">
              <div className="w-full flex items-start lg:justify-normal h-28">
                <p className="text-primary dark:text-secondary h2">Configurações</p>
              </div>
              <div className="w-fit h-16 flex flex-col justify-start">
                <p className="h3 dark:text-white">Configurações Gerais </p>
                <p className="p dark:text-white">Aqui você encontra algumas configurações que abrangem todo o aplicativo!</p>
              </div>
              <div className="w-full h-fit">
                ...
                <InputFieldConfig id={"googleCalendar"} type={"checkbox"} label={"Google Agendas"} value={t("dark-mode-configs")} checked={googleCalendar } onChange={(e) => ({})} />
                <InputFieldConfig id={"language"} type={"checkbox"} label={"Idioma"} value={t("dark-mode-configs")} checked={themeToggle} onChange={(e) => ({})} />
                <InputFieldConfig id={"fontSize"} type={"checkbox"} label={"Tamanho da fonte"} value={t("dark-mode-configs")} checked={themeToggle} onChange={(e) => ({})} />
              </div>
            </div>
            <div className="w-[95%]">
              <div className=" flex flex-col gap-3 lg:h-40 h-48 ">
