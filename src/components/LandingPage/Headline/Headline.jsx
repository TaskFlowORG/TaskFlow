...
export const Headline = () => {
  return (
    <div className={`flex flex-col lg:w-1/2 2xl:w-1/3 p-4 md:p-6 gap-6 relative `}>
      <h1 className="text-primary h2 lg:text-[56px] whitespace-nowrap">Headline Here</h1>
      ...
      <Button width={"w-min"} padding={"px-6"} other={"md:text-[16px] md:px-12 lg:text-[20px]"} textSize={"text-[14px]"} />
    </div>
  )
}