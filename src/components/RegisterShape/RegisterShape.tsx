...
<>
             ...
             <svg width="1511" height="798" viewBox="0 0 1511 798" fill="none" xmlns="http:
             www.w3.org/2000/svg" className="fixed z-[-1] bottom-0 left-0">
             ...
             <svg width="297" height="156" viewBox="0 0 297 156" fill="none" xmlns="http:
             www.w3.org/2000/svg" className="fixed z-[-1] top-1 left-[720px]">

                 <g filter="url(#filter0_d_1020_9271)">

                     <path d="M251.32 8.55156C250.298 66.2563 202.69 112.206 144.985 111.184L137.986 111.06C80.2815 110.037 34.3316 62.4292 35.3542 4.72453C36.3767 -52.9802 83.9846 -98.9301 141.689 -97.9076L148.688 -97.7835C206.393 -96.761 252.343 -49.1531 251.32 8.55156Z" fill="url(#paint0_angular_1020_9271)" fillOpacity="0.9" shapeRendering="crispEdges" />

                 </g>

                 <defs>

                     <filter id="filter0_d_1020_9271" x="0.335938" y="-133.926" width="296" height="289.125" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                         ...
                         <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_1020_9271" />

                         <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_1020_9271" result="shape" />

                     </filter>

                     <radialGradient id="paint0_angular_1020_9271" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(39.0903 -11.3916) rotate(-39.1748) scale(136.862 75.3026)">
             ...
             <svg width="217" height="329" viewBox="0 0 217 329" fill="none" xmlns="http:
             www.w3.org/2000/svg" className=" fixed z-[-1] bottom-0 right-0">
