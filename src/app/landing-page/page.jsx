    ...
    <div className="flex flex-col items-center w-screen">
      ...
      <div className="w-full h-full flex flex-col gap-[6.125rem]">
        ...
        <div className="w-full flex flex-col">
          <h2 className="text-pink self-center">Conheça nossos desenvolvedores!</h2>
          <div className="shadowww rounded-lg flex flex-col gap-4 p-6 pt-12 max-w-[320px]  max-h-[254px] w-max">
            <h3 className="text-pink">Cleiton do pneu</h3>
            <p className="h-full overflow-auto">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi vero repellendus beatae aut dolore exercitationem. </p>
          </div>
        </div>
      </div>
