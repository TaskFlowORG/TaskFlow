    ...
    <div className="flex flex-col items-center w-screen">
      ...
      <div className="w-full h-full flex flex-col gap-[6.125rem]">
        ...
        <div className="flex flex-col w-full items-center gap-[4.5rem]">
          <h2 className="text-pink self-center">Como o TaskFlow funciona?</h2>
          <div className="flex gap-16">
            <div className="flex flex-col gap-12 w-[26.375rem]">
              ...
              <RoundedCard changeImage={() => setImage("moon.svg")} color={"#EA35BE"} >
                <LandingPageCardContent color={"text-[#EA35BE]"} title={"Projetos"} text={"Lorem ipsum dolor sit amet consectetur. In quis molestie a at placerat morbi vitae aenean. Viverra mauris imperdiet ac at habitant ut diam. Id id adipiscing aenean facilisi et mi. Viverra tristique ac bibendum arcu."} />
              </RoundedCard>
              <RoundedCard changeImage={() => setImage("language.svg")} color={"#E41CEF"} >
                <LandingPageCardContent color={"text-[#E41CEF]"} title={"Projetos"} text={"Lorem ipsum dolor sit amet consectetur. In quis molestie a at placerat morbi vitae aenean. Viverra mauris imperdiet ac at habitant ut diam. Id id adipiscing aenean facilisi et mi. Viverra tristique ac bibendum arcu."} />
              </RoundedCard>
            </div>
            <img src={image} alt="" />
          </div>
        ...
        <div className="w-full flex flex-col items-center gap-[4.5rem] ">
          <h2 className="text-pink self-center">Nossas Funcionalidades</h2>
