...
export default function Home({ params }: { params: { user: string, project: number, group: number } }) {
    ...
    return (
        ...
        <div className="group-page w-screen h-screen">
            ...
            <div className="w-full h-screen md:h-auto flex flex-col lg:flex-row lg:gap-8 xl:gap-32 pb-16 pt-32">
                ...
                <div className="flex flex-col lg:flex-row lg:w-1/2 pt-12 lg:pt-0">
